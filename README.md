...
| 05 | 2022 |[Trading AI with Reinforcment Learning](05-Trading AI)| GME Data | PPO |Stable Baseline  | WIP |

## Real-World Projects
| No. | Year | Project | Description | Alogrithm | RL Library | Status | 
| --- | ---- | ------- | ----------- | --------- | ---------- | ------ |
| 01 | 2021 - Present |[AI-driven MEP Plantroom [Source Code Confidential]]()| Using RL attempts to automate the service routings in Mechanical Plantroom, which is one of the world challenges problem in construction industry| PPO and POCA| Unity ML-agent | Concept Proof Succeed | 
